...
account_sid = 'ACc7f086ad0ab97a5915c1f142b9d84157'
auth_token = '75bec2d2851bbc70c3cd50c8a847ff47'
...
def send_sms(body, to_number):
  message = client.messages.create(body=body, from_='+16592645664', to=to_number)

def generate_otp():
  return random.randint(1000, 9999)

def send_otp(otp, phone_number):
  message = client.messages.create(body=f"Your OTP for {datetime.today().date()} is {otp}",from_='+16592645664',to=phone_number)
